...
0000000000010990 <deregister_tm_clones>:
   10990:	d503201f 	nop
   10994:	101063e0 	adr	x0, 31610 <__TMC_END__>
   10998:	d503201f 	nop
   1099c:	101063a1 	adr	x1, 31610 <__TMC_END__>
...
00000000000109c0 <register_tm_clones>:
   109c0:	d503201f 	nop
   109c4:	10106260 	adr	x0, 31610 <__TMC_END__>
   109c8:	d503201f 	nop
   109cc:	10106221 	adr	x1, 31610 <__TMC_END__>
...
0000000000010a54 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_>:
   ...
   10b2c:	54001428 	b.hi	10db0 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x35c>  // b.pmore
   ...
   10b44:	54000063 	b.cc	10b50 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0xfc>  // b.lo, b.ul, b.last
   10b48:	aa0b03ee 	mov	x14, x11
   10b4c:	14000065 	b	10ce0 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x28c>
   ...
   10cd0:	54fff521 	b.ne	10b74 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x120>  // b.any
   10cd4:	eb0d01df 	cmp	x14, x13
   10cd8:	540006c0 	b.eq	10db0 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x35c>  // b.none
   ...
   10dac:	54fffb01 	b.ne	10d0c <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x2b8>  // b.any
   ...
   10dc4:	54000180 	b.eq	10df4 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x3a0>  // b.none
   ...
   10dec:	54ffea29 	b.ls	10b30 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0xdc>  // b.plast
   10df0:	17fffff0 	b	10db0 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x35c>
   ...
   10e64:	54fffd21 	b.ne	10e08 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x3b4>  // b.any
   ...
   10ec4:	54fffd41 	b.ne	10e6c <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x418>  // b.any
   10ec8:	b85dc3a9 	ldur	w9, [x29, #-36]
   10ecc:	b9402be8 	ldr	w8, [sp, #40]
   10ed0:	11000529 	add	w9, w9, #0x1
   10ed4:	6b08013f 	cmp	w9, w8
   10ed8:	54ffdfe1 	b.ne	10ad4 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_+0x80>  // b.any
...
0000000000010f08 <main>:
   ...
   10fa0:	b4001993 	cbz	x19, 112d0 <main+0x3c8>
   10fa4:	b4001974 	cbz	x20, 112d0 <main+0x3c8>
   10fa8:	b4001955 	cbz	x21, 112d0 <main+0x3c8>
   10fac:	b4001936 	cbz	x22, 112d0 <main+0x3c8>
   10fb0:	b4001917 	cbz	x23, 112d0 <main+0x3c8>
   10fb4:	b40018f8 	cbz	x24, 112d0 <main+0x3c8>
   10fb8:	b40018d9 	cbz	x25, 112d0 <main+0x3c8>
   10fbc:	b40018ba 	cbz	x26, 112d0 <main+0x3c8>
   10fc0:	d28fe5a9 	mov	x9, #0x7f2d                	// #32557
   10fc4:	90ffff8d 	adrp	x13, 0 <__abi_tag-0x2c4>
   10fc8:	f2a992a9 	movk	x9, #0x4c95, lsl #16
   10fcc:	aa0003fc 	mov	x28, x0
   10fd0:	f2de85a9 	movk	x9, #0xf42d, lsl #32
   10fd4:	aa1f03e8 	mov	x8, xzr
   10fd8:	f2eb0a29 	movk	x9, #0x5851, lsl #48
   10fdc:	5280002c 	mov	w12, #0x1                   	// #1
   10fe0:	b24003ea 	orr	x10, xzr, #0x1
   10fe4:	d2e7940b 	mov	x11, #0x3ca0000000000000    	// #4368491638549381120
   10fe8:	1e7e1000 	fmov	d0, #-1.000000000000000000e+00
   10fec:	fd43c1a1 	ldr	d1, [x13, #1920]
   10ff0:	1e6c1002 	fmov	d2, #5.000000000000000000e-01
   10ff4:	9b09298c 	madd	x12, x12, x9, x10
   10ff8:	9e670166 	fmov	d6, x11
   10ffc:	d34bfd8d 	lsr	x13, x12, #11
   11000:	9b09298e 	madd	x14, x12, x9, x10
   11004:	9e6301a3 	ucvtf	d3, x13
   11008:	9b0929cd 	madd	x13, x14, x9, x10
   1100c:	d34bfdce 	lsr	x14, x14, #11
   11010:	9b0929ac 	madd	x12, x13, x9, x10
   11014:	d34bfdad 	lsr	x13, x13, #11
   11018:	9e6301d0 	ucvtf	d16, x14
   1101c:	1e660863 	fmul	d3, d3, d6
   11020:	d34bfd8f 	lsr	x15, x12, #11
   11024:	9b092990 	madd	x16, x12, x9, x10
   11028:	9e6301b2 	ucvtf	d18, x13
   1102c:	d37df10d 	lsl	x13, x8, #3
   11030:	91000508 	add	x8, x8, #0x1
   11034:	9e6301e4 	ucvtf	d4, x15
   11038:	1e660a10 	fmul	d16, d16, d6
   1103c:	9b092a0f 	madd	x15, x16, x9, x10
   11040:	d34bfe10 	lsr	x16, x16, #11
   11044:	1e632863 	fadd	d3, d3, d3
   11048:	f117711f 	cmp	x8, #0x5dc
   1104c:	9b0929ec 	madd	x12, x15, x9, x10
   11050:	d34bfdef 	lsr	x15, x15, #11
   11054:	9e630207 	ucvtf	d7, x16
   11058:	1e660884 	fmul	d4, d4, d6
   1105c:	d34bfd91 	lsr	x17, x12, #11
   11060:	1e602863 	fadd	d3, d3, d0
   11064:	9e6301f1 	ucvtf	d17, x15
   11068:	1e702a10 	fadd	d16, d16, d16
   1106c:	9e630225 	ucvtf	d5, x17
   11070:	1e6608e7 	fmul	d7, d7, d6
   11074:	1e642884 	fadd	d4, d4, d4
   11078:	fc2d6a63 	str	d3, [x19, x13]
   1107c:	1e660a31 	fmul	d17, d17, d6
   11080:	1e602a10 	fadd	d16, d16, d0
   11084:	1e6608a5 	fmul	d5, d5, d6
   11088:	1e660a46 	fmul	d6, d18, d6
   1108c:	1e6728e7 	fadd	d7, d7, d7
   11090:	1e602884 	fadd	d4, d4, d0
   11094:	1e712a31 	fadd	d17, d17, d17
   11098:	fc2d6a90 	str	d16, [x20, x13]
   1109c:	1e6528a5 	fadd	d5, d5, d5
   110a0:	1e6628c6 	fadd	d6, d6, d6
   110a4:	1e6028e7 	fadd	d7, d7, d0
   110a8:	1e610883 	fmul	d3, d4, d1
   110ac:	1e602a31 	fadd	d17, d17, d0
   110b0:	1e6028a5 	fadd	d5, d5, d0
   110b4:	1e6028c6 	fadd	d6, d6, d0
   110b8:	1e6108e4 	fmul	d4, d7, d1
   110bc:	fc2d6ac3 	str	d3, [x22, x13]
   110c0:	fc2d6aa6 	str	d6, [x21, x13]
   110c4:	1e610a26 	fmul	d6, d17, d1
   110c8:	1e60c0a5 	fabs	d5, d5
   110cc:	fc2d6ae4 	str	d4, [x23, x13]
   110d0:	fc2d6b06 	str	d6, [x24, x13]
   110d4:	1e6228a3 	fadd	d3, d5, d2
   110d8:	fc2d6b23 	str	d3, [x25, x13]
   110dc:	54fff8c1 	b.ne	10ff4 <main+0xec>  // b.any
   110e0:	528000a0 	mov	w0, #0x5                   	// #5
   110e4:	aa1303e1 	mov	x1, x19
   110e8:	aa1403e2 	mov	x2, x20
   110ec:	aa1503e3 	mov	x3, x21
   110f0:	aa1603e4 	mov	x4, x22
   110f4:	aa1703e5 	mov	x5, x23
   110f8:	aa1803e6 	mov	x6, x24
   110fc:	aa1903e7 	mov	x7, x25
   11100:	a900f3fb 	stp	x27, x28, [sp, #8]
   11104:	f90003fa 	str	x26, [sp]
   11108:	97fffe53 	bl	10a54 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_>
   1110c:	910083e1 	add	x1, sp, #0x20
   11110:	52800020 	mov	w0, #0x1                   	// #1
   11114:	940000ab 	bl	113c0 <clock_gettime@plt>
   11118:	fd4017e0 	ldr	d0, [sp, #40]
   1111c:	aa1b03e8 	mov	x8, x27
   11120:	52803200 	mov	w0, #0x190                 	// #400
   11124:	aa1303e1 	mov	x1, x19
   11128:	aa1403e2 	mov	x2, x20
   1112c:	aa1503e3 	mov	x3, x21
   11130:	aa1603e4 	mov	x4, x22
   11134:	aa1703e5 	mov	x5, x23
   11138:	aa1803e6 	mov	x6, x24
   1113c:	aa1903e7 	mov	x7, x25
   11140:	f94013fb 	ldr	x27, [sp, #32]
   11144:	5e61d808 	scvtf	d8, d0
   11148:	f81f83bc 	stur	x28, [x29, #-8]
   1114c:	a900f3e8 	stp	x8, x28, [sp, #8]
   11150:	aa0803fc 	mov	x28, x8
   11154:	f90003fa 	str	x26, [sp]
   11158:	97fffe3f 	bl	10a54 <_Z9run_stepsiiddPdS_S_S_S_S_S_S_S_S_>
   1115c:	910083e1 	add	x1, sp, #0x20
   11160:	52800020 	mov	w0, #0x1                   	// #1
   11164:	94000097 	bl	113c0 <clock_gettime@plt>
   11168:	fd4017e0 	ldr	d0, [sp, #40]
   1116c:	2f00e401 	movi	d1, #0x0
   11170:	f94013e8 	ldr	x8, [sp, #32]
   11174:	9285dbe9 	mov	x9, #0xffffffffffffd120    	// #-12000
   11178:	5e61d800 	scvtf	d0, d0
   1117c:	8b09026a 	add	x10, x19, x9
   11180:	8b09028b 	add	x11, x20, x9
   11184:	8b0902ac 	add	x12, x21, x9
   11188:	3dcbb942 	ldr	q2, [x10, #12000]
   1118c:	3dcbb963 	ldr	q3, [x11, #12000]
   11190:	3dcbbd44 	ldr	q4, [x10, #12016]
   11194:	8b0902ca 	add	x10, x22, x9
   11198:	3dcbbd65 	ldr	q5, [x11, #12016]
   1119c:	8b0902eb 	add	x11, x23, x9
   111a0:	4e63d442 	fadd	v2.2d, v2.2d, v3.2d
   111a4:	3dcbb983 	ldr	q3, [x12, #12000]
   111a8:	4e65d484 	fadd	v4.2d, v4.2d, v5.2d
   111ac:	3dcbbd85 	ldr	q5, [x12, #12016]
   111b0:	8b09030c 	add	x12, x24, x9
   111b4:	b1008129 	adds	x9, x9, #0x20
   111b8:	4e63d442 	fadd	v2.2d, v2.2d, v3.2d
   111bc:	3dcbb943 	ldr	q3, [x10, #12000]
   111c0:	4e65d484 	fadd	v4.2d, v4.2d, v5.2d
   111c4:	3dcbbd45 	ldr	q5, [x10, #12016]
   111c8:	4e63d442 	fadd	v2.2d, v2.2d, v3.2d
   111cc:	3dcbb963 	ldr	q3, [x11, #12000]
   111d0:	4e65d484 	fadd	v4.2d, v4.2d, v5.2d
   111d4:	3dcbbd65 	ldr	q5, [x11, #12016]
   111d8:	4e63d442 	fadd	v2.2d, v2.2d, v3.2d
   111dc:	3dcbb983 	ldr	q3, [x12, #12000]
   111e0:	4e63d442 	fadd	v2.2d, v2.2d, v3.2d
   111e4:	4e65d483 	fadd	v3.2d, v4.2d, v5.2d
   111e8:	5e180444 	mov	d4, v2.d[1]
   111ec:	1e622821 	fadd	d1, d1, d2
   111f0:	3dcbbd82 	ldr	q2, [x12, #12016]
   111f4:	4e62d462 	fadd	v2.2d, v3.2d, v2.2d
   111f8:	1e642821 	fadd	d1, d1, d4
   111fc:	5e180443 	mov	d3, v2.d[1]
   11200:	1e622821 	fadd	d1, d1, d2
   11204:	1e632821 	fadd	d1, d1, d3
   11208:	54fffba1 	b.ne	1117c <main+0x274>  // b.any
   1120c:	d2d09009 	mov	x9, #0x848000000000        	// #145685290680320
   11210:	9e620104 	scvtf	d4, x8
   11214:	f2e825c9 	movk	x9, #0x412e, lsl #48
   11218:	f0ffff60 	adrp	x0, 0 <__abi_tag-0x2c4>
   1121c:	911e2000 	add	x0, x0, #0x788
   11220:	9e670122 	fmov	d2, x9
   11224:	d2c80009 	mov	x9, #0x400000000000        	// #70368744177664
   11228:	f2e811e9 	movk	x9, #0x408f, lsl #48
   1122c:	1e621903 	fdiv	d3, d8, d2
   11230:	9e670125 	fmov	d5, x9
   11234:	1e650884 	fmul	d4, d4, d5
   11238:	1e621800 	fdiv	d0, d0, d2
   1123c:	9e620362 	scvtf	d2, x27
   11240:	1e650842 	fmul	d2, d2, d5
   11244:	1e632842 	fadd	d2, d2, d3
   11248:	1e602880 	fadd	d0, d4, d0
   1124c:	1e623800 	fsub	d0, d0, d2
   11250:	94000054 	bl	113a0 <printf@plt>
   11254:	aa1303e0 	mov	x0, x19
   11258:	94000056 	bl	113b0 <free@plt>
   1125c:	aa1403e0 	mov	x0, x20
   11260:	94000054 	bl	113b0 <free@plt>
   11264:	aa1503e0 	mov	x0, x21
   11268:	94000052 	bl	113b0 <free@plt>
   1126c:	aa1603e0 	mov	x0, x22
   11270:	94000050 	bl	113b0 <free@plt>
   11274:	aa1703e0 	mov	x0, x23
   11278:	9400004e 	bl	113b0 <free@plt>
   1127c:	aa1803e0 	mov	x0, x24
   11280:	9400004c 	bl	113b0 <free@plt>
   11284:	aa1903e0 	mov	x0, x25
   11288:	9400004a 	bl	113b0 <free@plt>
   1128c:	aa1a03e0 	mov	x0, x26
   11290:	94000048 	bl	113b0 <free@plt>
   11294:	aa1c03e0 	mov	x0, x28
   11298:	94000046 	bl	113b0 <free@plt>
   1129c:	f85f83a0 	ldur	x0, [x29, #-8]
   112a0:	94000044 	bl	113b0 <free@plt>
   112a4:	2a1f03f3 	mov	w19, wzr
   112a8:	2a1303e0 	mov	w0, w19
   112ac:	fd401be8 	ldr	d8, [sp, #48]
   112b0:	a9494ff4 	ldp	x20, x19, [sp, #144]
   112b4:	a94857f6 	ldp	x22, x21, [sp, #128]
   112b8:	a9475ff8 	ldp	x24, x23, [sp, #112]
   112bc:	a94667fa 	ldp	x26, x25, [sp, #96]
   112c0:	a9456ffc 	ldp	x28, x27, [sp, #80]
   112c4:	a9447bfd 	ldp	x29, x30, [sp, #64]
   112c8:	910283ff 	add	sp, sp, #0xa0
   112cc:	d65f03c0 	ret
   112d0:	90000088 	adrp	x8, 21000 <memset@plt+0xfc20>
   112d4:	d503201f 	nop
   112d8:	70f7a660 	adr	x0, 7a7 <_IO_stdin_used+0x37>
   112dc:	52800241 	mov	w1, #0x12                  	// #18
   112e0:	52800022 	mov	w2, #0x1                   	// #1
   112e4:	52800033 	mov	w19, #0x1                   	// #1
   112e8:	f942fd08 	ldr	x8, [x8, #1528]
   112ec:	f9400103 	ldr	x3, [x8]
   112f0:	94000038 	bl	113d0 <fwrite@plt>
   112f4:	17ffffed 	b	112a8 <main+0x3a0>

Disassembly of section .init:

00000000000112f8 <_init>:
   112f8:	d503201f 	nop
   112fc:	a9bf7bfd 	stp	x29, x30, [sp, #-16]!
   11300:	910003fd 	mov	x29, sp
   11304:	97fffd9c 	bl	10974 <call_weak_fn>
   11308:	a8c17bfd 	ldp	x29, x30, [sp], #16
   1130c:	d65f03c0 	ret

Disassembly of section .fini:

0000000000011310 <_fini>:
   11310:	d503201f 	nop
   11314:	a9bf7bfd 	stp	x29, x30, [sp, #-16]!
   11318:	910003fd 	mov	x29, sp
   1131c:	a8c17bfd 	ldp	x29, x30, [sp], #16
   11320:	d65f03c0 	ret
...
0000000000011330 <abort@plt-0x20>:
   ...
   11338:	f9431211 	ldr	x17, [x16, #1568]
   1133c:	91188210 	add	x16, x16, #0x620
